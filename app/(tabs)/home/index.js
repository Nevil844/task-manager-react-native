...
const index = () => {
  ...
  const addTodo = async () => {
    try {
      ...
      axios
        .post("http://192.168.29.172:3000/todos/65b0035e8d272ceb95885586", todoData)
        .then((response) => {
  ...
  const getUserTodos = async () => {
    try {
      const response = await axios.get(
        `http://192.168.29.172:3000/users/65b0035e8d272ceb95885586/todos`
      );
  ...
  const markTodoAsCompleted = async (todoId) => {
    try {
      ...
      const response = await axios.patch(
        `http://192.168.29.172:3000/todos/${todoId}/complete`
      );
